...
<div class="part1">
	...
	<p style="color:rgb(60,155,255);margin-left:30px;font-size:20px;font-family:courier;text-decoration:bold">
		<b style="font-size:24px">DIVERSITYjobs</b></p>
		</td>
		<td>
		<p style="color:rgb(60,155,255);margin-left:30px;font-size:20px;font-family:courier;text-decoration:bold">
	<a href="hi">Jobs</a>  </p>
	...
	<a href="exam.php">Give Exam</a></p>
		...
		<span class="dropdown">
			<button class="dropbtn">JobSeeker</button>
				<span class="dropdown-content">
					<a href="register1.php">Sign up</a>
					<a href="loginjobseeker.php">Login</a>
				</span>
		</span> 
	
		<span class="dropdown">
			<button class="dropbtn">Recruiter</button>
				<span class="dropdown-content">
					<a href="register2.php">Sign up</a>
					<a href="loginrecruiter.php">Login</a>
				</span>
		</span> 
		<span class="dropdown">
	...
	<table width="100%">
		...
		<td style="text-align:center;">	
			<a style="font-size:24px;text-decoration:bold;display:inline-block;padding:10px;background-color:rgb(100,10,50);color:white;" href="upload.php">Upload Resume</a>
		</td>
		</tr>	
		</table>
</div>
<div>
	<div id="demo" height="500"></div>
	<div id="demo1" style="background-image:url('capture.PNG');background-repeat:no repeat;" href="http://diversityjobs.com/?utm_source=bing&utm_campaign=DJ-dynamic" height="500"></div>
	<iframe src="part1.html" height="500" width="350"></iframe>
